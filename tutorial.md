...
[Moodle LMS](https://moodle.org/) an open-source Learning Management System (LMS), has become an integral part of the educational landscape in schools, universities, and corporations around the world. Its modular structure and adaptability make it a preferred choice for various online learning scenarios.

If you want to set up Moodle quickly and without much hassle, that's where Acorn comes in. [Acorn](http://www.acorn.io) provides a straightforward way to get Moodle up and running in a cloud environment. It's great for those who want to experiment or even use Moodle for a live project without worrying about complex server setups. Acorn provides a cloud-native environment with a free sandbox accessible, which makes it easier to host Moodle for anyone with a GitHub account.
...
If you want to skip to the end, just click [Run in Acorn](https://acorn.io/run/ghcr.io/infracloudio/moodle-acorn:v4.3.0-1?ref=slayer321&name=moodle) to launch the Moodle application immediately in a free sandbox environment. All you need to join is a GitHub ID to create an account.
...
3. Choose the source for deploying your Acorns
   ...
   ![Select Acorn](./assets/select-from-acorn-image.png)
   ...
   ![Deploy](./assets/moodle-deploy-preview.png)
...
4. Once the Acorn is running, you can access it by clicking the Endpoint or the redirect link.
   ...
   ![Acorn Dashboard](./assets/moodle-platform-dashboard.png)

   4.2. Running Moodle
   ![Moodle Application](./assets/moodle-dashboard.png)
...
Once we provide all the details and our moodle application is running below is what our moodle dashboard looks like once we logged in.

![Moodle Dashboard](./assets/moodle-dashboard.png)

## What's Next?

1. The Moodle Application is provisioned on Acorn Platform is available for two hours, you would need to Upgrade to Pro account if you want to to keep running longer durations.
2. After deploying you can edit the Acorn Application or remove it if no longer needed. Click the `Edit` option to edit your Acorn's Image. Toggle the Advanced Options switch for additional edit options.
3. Remove the Acorn by selecting the `Remove` option from your Acorn dashboard.

## Conclusion

In this tutorial, we learned how to use the Acornfile and deploy the Moodle application. Also, different modes of deployments, such as Acorn Dashboard and Acorn CLI, were discussed, with Acorn Dashboard providing a much easier process to get started. It allows you to run the Moodle application directly by providing the image name. Furthermore, the sandbox environment is suitable for initial experiments, but a Pro account is recommended for longer duration deployments. This combination of Moodle's comprehensive features and Acorn's deployment simplicity provides an effective solution for a learning management system.
